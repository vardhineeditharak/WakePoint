/**
 * Enhanced High-Contrast Dark Navigation Map Style for MapLibre GL.
 * Powered by OpenFreeMap global planet vector tiles.
 * 
 * Specifically calibrated for optimal nighttime and outdoor visibility:
 * - High-contrast road hierarchy (local, major, arterial, and expressways are clearly distinguishable)
 * - Razor-sharp white street names and city labels with deep dark protective halos
 * - Vibrant sapphire water bodies and distinct emerald green parks
 * - Crisp architectural footprints for buildings
 * - Zero API key requirements, 100% free, loaded directly in-memory for 0ms style latency
 */
export const ENHANCED_DARK_MAP_STYLE = {
  version: 8,
  sources: {
    ne2_shaded: {
      maxzoom: 6,
  ...
  layers: [
    ...
    },
    {
      ...
      layout: { 'line-cap': 'round', 'line-join': 'round' },
      paint: {
        'line-color': 'rgba(90, 110, 145, 0.8)',
        'line-opacity': 1,
    ...
    },
    {
      ...
      paint: { 'fill-color': '#161D2A', 'fill-opacity': 1 },
    },
    {
      id: 'aeroway-runway',
      type: 'line',
    ...
    },
    {
      ...
      paint: { 'fill-antialias': true, 'fill-color': '#111622' },
    },
    {
      id: 'road_pier',
      type: 'line',
    ...
    },
    {
      ...
      paint: { 'line-color': '#3B4D6D', 'line-width': 3 },
    },
    {
      ...
      layout: { 'line-join': 'round' },
      paint: { 'line-color': '#111622', 'line-dasharray': [3, 3], 'line-width': 2 },
    },
    {
      id: 'railway_minor',
      type: 'line',
    ...
    },
    {
      ...
      filter: [
        ...
        ['match', ['get', 'class'], ['hamlet', 'isolated_dwelling', 'neighbourhood'], true, false],
      ],
      layout: {
        'text-anchor': 'center',
        'text-field': [
